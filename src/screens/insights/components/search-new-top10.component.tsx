...
@withLocalization
class SearchNewTop10 extends Component {
  static propTypes = {
    ...
    return (
      ...
      >
        <View>
          <View>
            <InsightHeader
              content={t("INSIGHTS:INSIGHTS:SEARCH:NEW_TOP10:WE_FOUND", {
          ...
          <View style={style.marginTop10}>
            <InsightText
              text={t("INSIGHTS:INSIGHTS:SEARCH:NEW_TOP10:LET_US_KNOW")}
            />
          </View>
...
export default connectStyle(STYLE_NAME, {})(SearchNewTop10);
