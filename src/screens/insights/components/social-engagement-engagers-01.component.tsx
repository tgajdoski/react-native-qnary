...
@withLocalization
class SocialEngagementEngagers01 extends Component {
  static propTypes = {
      ...
      >
        <View>
            ...
            {Object.entries(engagers).map(engager => {
              ...
              return (
                <View key={`${engager[1].id}`}>
                  <InsightHeader
                    content={t(
                      "INSIGHTS:INSIGHTS:SOCIAL:ENGAGEMENT:ENGAGERS:MOST_INFLUENTIAL",
                      {
          ...
          <View style={style.marginTop10}>
            <InsightText
              text={t("INSIGHTS:INSIGHTS:SOCIAL:ENGAGEMENT:ENGAGERS:REACH_OUT")}
            />
          </View>
...
export default connectStyle(STYLE_NAME, {})(SocialEngagementEngagers01);
